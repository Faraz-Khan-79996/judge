        ...
        >
            <div className="container tw-mx-auto tw-p-6">
                <header className="tw-mb-6 tw-flex tw-items-center tw-justify-between">
                    <h1 className="tw-text-3xl tw-font-bold">@{userProfileData.username}</h1>
                </header>
                    ...
                    <TabContext value={value}>
                        ...
                        <TabPanel value="2">
                            <DislikedProblemsTable
                                dislikedProblems={
                                    userProfileData.dislikedProblems
                                }
                            />
                        </TabPanel>
                        <TabPanel value="3">
                        ...
                        <TabPanel value="4">
                            <SubmissionsTable
                                submissions={userProfileData.submissions}
                            />
                        </TabPanel>
                    </TabContext>
                </Box>
                                ...
                                ? submissions.length > 0
                                    ? submissions.map((submission) => (
                                          ...
                                          >
                                              ...
                                              <td className="tw-px-6 tw-py-4">
                                                  <Pill mode={submission.status == "Accepted" ? "easy" : "hard"} text={submission.status} />
                                              </td>
                                              <td className="tw-px-6 tw-py-4">
                                                  {submission.language}
                                              </td>
